...
- [privacy_inspector](https://github.com/anshu7vyas/privacy_inspector) — Security monitoring tool for Android devices
- [stocked](https://github.com/anshu7vyas/stocked) — Android grocery management app
- [GitTrends](https://github.com/anshu7vyas/GitTrends) — Trending GitHub repositories browser for Android
- [trainOS](https://github.com/anshu7vyas/trainOS) — Preemptive multitasking educational OS in C
- [hope4haiti](https://github.com/tfi-fellowship/hope4haiti) — Fellowship project with Mercy Beyond Borders
